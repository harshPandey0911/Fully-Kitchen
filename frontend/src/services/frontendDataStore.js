...
const sanitizeRegisteredProduct = (record = {}, existing = {}) => {
  ...
  return {
    ...
    invoiceUrl: String(record.invoiceUrl || existing.invoiceUrl || '').trim(),
    invoicePublicId: String(record.invoicePublicId || existing.invoicePublicId || '').trim(),
...
const sanitizeServiceRequest = (record = {}, existing = {}) => ({
  ...
  imageUrl: String(record.imageUrl || existing.imageUrl || '').trim(),
  imagePublicId: String(record.imagePublicId || existing.imagePublicId || '').trim(),
